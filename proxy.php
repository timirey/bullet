...
$proxySources = [
    'http' => [
        ...
        // new 5 — 2026-06-05 audit (non-English & high-cadence)
        'https://api.proxyscrape.com/v4/free-proxy-list/get?request=display_proxies&proxy_format=ipport&protocol=http&format=text',
    ...
    'socks4' => [
        ...
        // new 5 — 2026-06-05 audit (non-English & high-cadence)
        'https://api.proxyscrape.com/v4/free-proxy-list/get?request=display_proxies&proxy_format=ipport&protocol=socks4&format=text',
    ...
    'socks5' => [
        ...
        // new 5 — 2026-06-05 audit (non-English & high-cadence)
        'https://api.proxyscrape.com/v4/free-proxy-list/get?request=display_proxies&proxy_format=ipport&protocol=socks5&format=text',
